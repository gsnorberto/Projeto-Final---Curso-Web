...
<template>
  <div class="user-admin">
    ...
    <b-form>
      <!-- Imput ID - Oculto para o usuário -->
      ...
      <!-- Checkbox para marcar como administrador -->
    ...
    <!-- Tabela com todos os usuários do BD -->
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        user: {}, //Usuário atualmente selecionado
        users: [], //todos os usuários do BD
        fields: [
    ...
    methods: {
      ...
      //Modo de Salvar ou Alterar um usuário
      save() {
      ...
      //Carregar um usuário na hora de editar ou excluir
